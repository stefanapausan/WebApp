...
$(document).ready(function(){
/*
  setTimeout(function() {noty({text: '<strong>Salut! Ai nevoie de ajutor?</strong>',layout:'topRight',type:'information',timeout:150000});}, 7000);

  setTimeout(function() {noty({text: 'Trimite-ne un e-mail la support@soft-build.com. Nu uita sa atasezi un printscreen, sa descrii pasii si sa ne dai informatiile necesare pentru a putea detecta eroarea. Multumim!',layout:'topRight',type:'alert',timeout:13000});}, 9000);
*/
});
