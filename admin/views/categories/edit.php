  ...
  <div class="widget wgreen">
	...
	<div class="widget-content">
	  <div class="padd">
		...
		<br />
		<!-- Form starts.  -->
		 <form class="form-horizontal" role="form" method="post" action="{SITE_URL}/categories/edit_done/{id_category}" enctype="multipart/form-data">
...
<input type="hidden" name="source" value="{source}" />
					...
					<div class="form-group">
					  ...
					  <div class="col-lg-5">
						<select class="form-control" id="id_parent" name="id_parent">
						 ...
						 {CATEGORIES}
							  <option value="{id_category_parent}" {parentselected}>{parent_category_name}</option>
								  {SUBCATEGORIES}
									<option value="{id_subcategory}" {subcategoryselected}>-->{subcategory_name}</option>
								  {/SUBCATEGORIES}
						  {/CATEGORIES}
						</select>
					  </div>
					...
					<div class="form-group">
					  ...
					  <div class="col-lg-6">
						<textarea class="cleditor" id="category_description" name="category_description" placeholder="Enter category description here...">{category_description}</textarea>
					  </div>
					</div>       
					...
					<div class="form-group">
					  ...
					  <div class="col-lg-5">
						<img src="{BASE_URL}/images/uploads/categories/{category_photo}"  /><br/>
					...
					<div class="form-group">
					  ...
					  <div class="col-lg-2">
						<select class="form-control" id="id_category_status" name="id_category_status">
						 {STATUS}
							  <option value="{id_category_status}" {selected}>{category_status}</option>
						  {/STATUS}
						</select>
					  </div>
					</div>     
