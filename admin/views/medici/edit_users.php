            ...
            <div class="col-md-12">
			<div class="row">
				<form class="form-horizontal" role="form" method="post" action="{SITE_URL}/users/edit_done1/{CNP}/" enctype="multipart/form-data">
							  ...
							  <div class="form-group">
                                  ...
                                  <div class="col-lg-5">
									...
									<input id="CNP" name="CNP" type="number"  placeholder="{CNP}" value="{CNP}" class="form-control" > 
								...
								<div class="form-group">
                                  ...
                                  <div class="col-lg-5">
									...
									<input id="data_nasterii" name="data_nasterii" type="date" placeholder="{data_nasterii}" value="{data_nasterii}" onfocus="(this.type='date')" class="form-control" > 
								...
								<div class="form-group">
                                  ...
                                  <label class="col-lg-2 control-label">Curs</label>

                                  <div class="col-lg-5">

									<input id="id" name="id" type="text"  placeholder="{Curs}" value="{Curs}" class="form-control" > 
