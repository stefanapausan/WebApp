...
<div class="col-md-12">
   <div class="col-md-6">
			...
			<h2 style="padding-left:13%; padding-top:20px">Restante</h2>
			...
			<table align="center" cellpadding="0" cellspacing="0" border="0"  >
					...
					<thead>
											...
											<tr align="center">
												<td  style="backgr	ound:#eef1f8; color:black">Nume curs</td>
												<td style="background:#eef1f8 color:black"> Durata</td>
												
												<td style="background:#eef1f8 color:black">Numar credite</td>	

												<td style="background:#eef1f8 color:black">Nota activitate</td>
												<td style="background:#eef1f8 color:black;">Nota examen</td>

												<td style="background:#eef1f8 color:black">Nota finala</td>
