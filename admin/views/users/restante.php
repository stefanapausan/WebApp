    <div class="row">
            ...
            <div class="col-md-12">
<div class="col-md-6"><h1 >Total sume restante: 22800</h1>
    ...
    <table align="center" cellpadding="0" cellspacing="0" border="0" >
										...
										<thead>
											...
											<tr align="center">
												...
												<td style="background:#eef1f8 color:black;">Taxa restanta</td>
...
<td style="background:grey; color:white;">{nume} {prenume}</td>
													...
													<td style="background:#eef1f8 color:black;">{taxa_restanta}</td>
